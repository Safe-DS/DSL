...
# :warning:{ title="Deprecated" } <code class="doc-symbol doc-symbol-class"></code> `LassoRegressor` {#safeds.ml.classical.regression.LassoRegressor data-toc-label='[class] LassoRegressor'}
