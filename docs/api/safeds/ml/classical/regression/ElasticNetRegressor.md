...
# :warning:{ title="Deprecated" } <code class="doc-symbol doc-symbol-class"></code> `ElasticNetRegressor` {#safeds.ml.classical.regression.ElasticNetRegressor data-toc-label='[class] ElasticNetRegressor'}
