...
# :warning:{ title="Deprecated" } <code class="doc-symbol doc-symbol-class"></code> `RidgeRegressor` {#safeds.ml.classical.regression.RidgeRegressor data-toc-label='[class] RidgeRegressor'}
