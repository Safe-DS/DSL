# :test_tube:{ title="Experimental" } `#!sds class` `OutputConversionImageToImage` {#safeds.ml.nn.converters.OutputConversionImageToImage data-toc-label='[class] OutputConversionImageToImage'}
