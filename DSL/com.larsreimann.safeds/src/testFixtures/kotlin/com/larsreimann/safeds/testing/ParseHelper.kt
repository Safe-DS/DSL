...
class ParseHelper @Inject constructor(
    private val parseHelper: ParseHelper<SdsCompilationUnit>,
    private val resourceSetProvider: Provider<ResourceSet>
) {

    /**
     * Parses the contents of the resource with the given [resourceName] and returns the contained [SdsCompilationUnit]
    ...
    /**
     * Parses the given [programText] and returns the contained [SdsCompilationUnit] or `null` if something went wrong.
    ...
    /**
     * Parses the given [programText] and returns the contained [SdsCompilationUnit] or `null` if something went wrong.
     * The [URI] of the [Resource] that contains the created [SdsCompilationUnit] is set to [uriToUse]. Any resources in
