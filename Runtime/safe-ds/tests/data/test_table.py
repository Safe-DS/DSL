...
def test_get_column_by_name_valid():
    ...
    assert isinstance(table.get_column_by_name("col1"), Column) and table.get_column_by_name("col1")._data[0] == \
           pd.Series(
               data=["col1_1"])[0] and table.get_column_by_name("col1")._data[0] == "col1_1"
