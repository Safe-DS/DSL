<script lang="ts">
    ...
    MessageHandler.handleSyncEvent((elements) => {
        ...
        const match = elements.segmentList.find((e) => e.type === $currentGraph.type && e.name === $currentGraph.name);
    ...
    <div class=" border-menu-400 relative box-border h-full w-full border-t-[1px]">
        <main class="h-full w-full">
            <Resizable.PaneGroup direction="horizontal">
                ...
                >
                    <Sidebar on:editSegment={handleEditSegment} {segmentList} {globalReferences} {selectedNodeList} />
                </Resizable.Pane>
