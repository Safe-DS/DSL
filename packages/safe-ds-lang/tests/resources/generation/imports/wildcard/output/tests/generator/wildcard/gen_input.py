...
def test():
    f(safeds_runner.server.pipeline_manager.runner_memoized_function_call("tests.generator.differentPackageWildcard.function1InDifferentPackage", function1InDifferentPackage, [], []))
    f(safeds_runner.server.pipeline_manager.runner_memoized_function_call("tests.generator.differentPackageWildcard.function1InDifferentPackage", function1InDifferentPackage, [], []))
    f(safeds_runner.server.pipeline_manager.runner_memoized_function_call("tests.generator.differentPackageWildcard.function2InDifferentPackage", function2InDifferentPackage, [], []))
    f(safeds_runner.server.pipeline_manager.runner_memoized_function_call("tests.generator.differentPackageWildcard.function2InDifferentPackage", function2InDifferentPackage, [], []))
