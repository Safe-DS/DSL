...
describe('SafeDsTypeChecker', async () => {
    ...
    describe('class types with type parameters', async () => {
        const code = `
            class TestClass {
                attr any: MyAny
        ...
        const subclassParameterizedInvariantNumber = computeTypeOfAttributeWithName(
            'subclassParameterizedInvariantNumber',
        );
        const subclassParameterizedCovariantNumber = computeTypeOfAttributeWithName(
            'subclassParameterizedCovariantNumber',
        );
