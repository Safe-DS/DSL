...
export class Utils {
    ...
    public static initialize(documentUri?: URI, safeDsServices?: SafeDsServices, logger?: SafeDsMessagingProvider) {
        Utils.errorList = [];
        ...
        Utils.safeDsServices = safeDsServices ? safeDsServices : Utils.safeDsServices;
    }
    ...
    public static warn(message: string) {
        Utils.logger.warn('AstParser', message);
    }

    public static logError(message: string, origin?: AstNode) {
        Utils.logger.error('AstParser', origin ? Utils.constructErrorMessage(message, origin) : message);
    }

    public static pushError(message: string, origin?: AstNode) {
        const error = new CustomError('block', Utils.constructErrorMessage(message, origin));
